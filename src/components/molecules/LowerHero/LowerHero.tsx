...
const LowerHero = () => {
  return (
    <div className="flex justify-center items-center lg:pt-28 md:pt-10 pt-0 relative pb-10">
      <div className="absolute -top-6 max-sm:-top-20 left-0 right-0 flex justify-center">
        <CircleGradient />
      </div>
